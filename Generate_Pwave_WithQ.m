...
function [PWavefield_XYZ,PWaveform_XYZ,PWaveform_Q_XYZ]=...
    Generate_Pwave_WithQ(Sample_Interval,Travel_T,Direction_Cosin,SR_Vec_model,MT,Rho,...
    Average_VpVs,Ricker_Der,SRecs_Qp,ELayerTime_SR_P)
