function [SWavefield_XYZ,SWaveform_XYZ,SWaveform_Q_XYZ]=...
    Generate_Swave_WithQ(Sample_Interval,Travel_T,Direction_Cosin,SR_Vec_model,MT,Rho,...
    Average_VpVs,Ricker_Der,SRecs_Qs,ELayerTime_SR)
