...
function [Receivers,Shot,Well_Num]=Set_Geometry_1Well
...
Azimuth=Azimuth_Int:Azimuth_Int:Azimuth_Int*(Well_Num-1);
...
for j=1:Rec_Num_1Well
    ...
    Receivers(j,3,1)=j*Rec_Depth_Int+2400;
end
% Calculate receiver position of the horizontal well
for j=1:Rec_Num_1Well
    Receivers(j,1,2)=Receivers(1,1,1)-Rec_Depth_Int*2*j;
    Receivers(j,2,2)=Receivers(1,2,1);
    Receivers(j,3,2)=Receivers(Rec_Num_1Well,3,1);
end
